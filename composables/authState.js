...
export const useAuthState = () => {
  ...
  return {
    ...
    candidateAccountCreated: computed(() => {
      ...
      return accountStore.$state.availableAccounts !== null && accountStore.$state.availableAccounts.length > 0 && accountStore.$state.availableAccounts.filter(acc => acc.accountType === candidateAccountType).length > 0
